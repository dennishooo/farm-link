...
export const CARD_TRANSLATIONS: Record<string, CardTranslation> = {
  ...
  'occupation-scholar': {
    title: '學士',
    text: '當你擁有石屋後，每回合開始時，你都可以支付 1 食物打出 1 張職業卡，或支付費用打出 1 張進步卡。',
  },
  'occupation-plowman': {
    title: '耕田人',
    text: '在目前回合數加 4、7、10 的回合格上各放 1 塊田地。這些回合開始時，你可支付 1 食物開墾該田地。',
  },
  'occupation-reeve': {
    title: '里正',
    text: '若尚有 1／3／6／9 回合可玩，獲得 1／2／3／4 木材。遊戲結束時，打出最多職業卡的所有玩家各得 3 分。',
  },
  'occupation-cube-cutter': {
    title: '方石切割工',
    text: '每次收成的田地階段，你可以用 1 木材和 1 食物換取 1 分。（將分數記錄在計分紙上。）',
  },
  'occupation-mother-of-twins': {
    title: '雙胞胎之母',
    text: '進行家庭成長時，你可以支付 3 食物一次帶入 2 位新家庭成員，且只需 1 個空房間。',
  },
  'occupation-dock-worker': {
    title: '碼頭工人',
    text: '任何時候都可以用碼頭工人將 3 木材換成 1 黏土、1 蘆葦或 1 石頭；或將 2 黏土、2 蘆葦或 2 石頭換成 1 個其他建材。',
  },
  'occupation-animal-trainer': {
    title: '動物訓練師',
    text: '每當你從「流浪藝人」格取得食物時，可立即用來買動物：每隻綿羊或野豬 2 食物，每隻牛 3 食物。',
  },
  'occupation-thatcher': {
    title: '蓋屋頂工',
    text: '建造每個房間、每次翻修，以及水磨坊、半木結構房屋、雞舍、渡假屋、宅邸與穀物倉庫，各少付 1 蘆葦。',
  },
  'occupation-animal-breeder': {
    title: '動物育種家',
    text: '每當你圍起未使用格形成至少一個新牧場時，可購買一對動物：2 綿羊 1 食物、2 野豬 2 食物、2 牛 3 食物。',
  },
  'occupation-constable': {
    title: '警官',
    text: '若尚有 1／3／6／9 回合可玩，立即獲得 1／2／3／4 木材。遊戲結束時，沒有負分的玩家各得 5 分。',
  },
  'occupation-market-crier': {
    title: '市場叫賣員',
    text: '每當你使用「取得 1 穀物」行動時，可額外取得 1 穀物和 1 蔬菜；若這麼做，其他玩家各從供應區獲得 1 穀物。',
  },
  'occupation-fence-overseer': {
    title: '柵欄監工',
    text: '每回合你可以支付 1 食物，立即在剛建好的馬廄周圍圍起 1 格的牧場，不需支付柵欄的木材。',
  },
  'occupation-hedge-keeper': {
    title: '樹籬管理員',
    text: '每當你建造至少 1 段柵欄時，可再免費建造 3 段柵欄。（柵欄仍必須圍成完整的牧場。）',
  },
  'occupation-tinsmith': {
    title: '錫匠',
    text: '任何時候都可以將黏土轉換成食物，每 1 黏土換 1 食物。若有玩家建造了水井（含村井），則每 2 黏土換 3 食物。',
  },
  'occupation-sycophant': {
    title: '諂媚者',
    text: '其他玩家使用「取得 1 穀物」行動格前必須先付你 1 食物。此外，即使你自己取得穀物，也從供應區獲得 1 食物。',
  },
  'occupation-brush-maker': {
    title: '製刷匠',
    text: '每當你將野豬轉換成食物時，可選擇把牠放在此卡上。遊戲結束時，2／3／4 隻已屠宰的野豬分別得 1／2／3 分。',
  },
  'occupation-bread-seller': {
    title: '麵包商',
    text: '每當任何玩家（包括你）烤麵包時，每烤 1 個穀物你就從供應區獲得 1 食物。',
  },
  'occupation-butcher': {
    title: '屠夫',
    text: '任何時候都可以將動物轉換成食物（即使沒有烹飪進步卡）：每隻綿羊 1 食物、野豬 2 食物、牛 3 食物。',
  },
  'occupation-carpenter': {
    title: '木匠',
    text: '擴建房屋時，每個新房間只需 3 個對應建材和 2 蘆葦。（例如住在木屋，只需 3 木材和 2 蘆葦。）',
  },
  'occupation-groom': {
    title: '馬伕',
    text: '當你擁有石屋後，每回合開始時可用 1 木材建造 1 座馬廄，不需放置家庭成員在行動格上。',
  },
  'occupation-lord-of-the-manor': {
    title: '莊園領主',
    text: '遊戲結束時，每個你拿到滿分 4 分的計分項目各得 1 分。（4 座圍起的馬廄也算。）',
  },
  'occupation-tenant-farmer': {
    title: '佃農',
    text: '你立即借得每種動物各 1 隻。計分前必須歸還這 3 隻動物；每隻無法或不願歸還的動物扣 1 分。',
  },
  'occupation-village-elder': {
    title: '村中長老',
    text: '若尚有 1／3／6／9 回合可玩，立即獲得 1／2／3／4 木材。遊戲結束時，打出最多進步卡的所有玩家各得 3 分。',
  },
  'occupation-house-steward': {
    title: '管家',
    text: '若尚有 1／3／6／9 回合可玩，立即獲得 1／2／3／4 木材。遊戲結束時，房間最多的玩家各得 3 分。',
  },
  'occupation-lover': {
    title: '情人',
    text: '打出此卡時，立即進行一次「家庭成長（不需空房）」行動。打出此卡需額外支付 4 食物。',
  },
  'occupation-forester': {
    title: '林務員',
    text: '每當你使用「播種」行動時，最多可在此卡上種 3 木材。木材視同已播種的穀物，在田地階段收成。',
  },
  'occupation-manufacturer': {
    title: '製造商',
    text: '當你擁有黏土屋或石屋後，木工坊、陶器坊與編籃工坊對你而言視為小進步卡，且費用減少 2 個你選擇的建材。',
  },
  'occupation-master-forester': {
    title: '林務大師',
    text: '加入 3 人遊戲的「2 木材」行動卡作為額外森林。每回合開始時在卡上放 2 木材。使用此行動的玩家必須付你 2 食物。',
  },
  'occupation-game-designer': {
    title: '遊戲設計師',
    text: '任何時候都可以用 1 木材、1 黏土、1 蘆葦和 1 石頭換取 2 食物和 1 分，次數不限。（將分數記錄在計分紙上。）',
  },
  'occupation-baker': {
    title: '麵包師',
    text: '每次收成時，若你有帶麵包符號的進步卡，可在餵食階段開始時烤麵包。打出此卡時，也可額外進行一次烤麵包。',
  },
  'occupation-wet-nurse': {
    title: '奶媽',
    text: '每當你擴建房間時，可依建造的房間數增加同樣多的家庭成員，每人支付 1 食物。（新生兒下回合才能行動。）',
  },
  'occupation-fieldsman': {
    title: '田間工人',
    text: '播種 1 塊田地時，從供應區額外放 2 個作物；播種 2 塊田地時，各額外放 1 個。（播種 3 塊以上則沒有好處。）',
  },
  'occupation-water-carrier': {
    title: '挑水夫',
    text: '一旦有玩家建造水井，就在剩餘的回合格上各放 1 食物。這些回合開始時，你獲得該食物。（若水井已建成，立即放置。）',
  },
  'occupation-organic-farmer': {
    title: '有機農夫',
    text: '遊戲結束時，每個至少有 1 隻動物、且還能再容納至少 3 隻的牧場各得 1 分。（林地牧場也適用。）',
  },
  'occupation-shepherd-boy': {
    title: '牧羊童',
    text: '當你住進石屋後，在剩餘的回合格上各放 1 綿羊。這些回合開始時，你獲得該綿羊。（若已住石屋，立即放置。）',
  },
  'occupation-dancer': {
    title: '舞者',
    text: '每當你使用「流浪藝人」行動格時，至少獲得 4 食物。（若格上只有 1 至 3 食物，從供應區補足至 4 食物。）',
  },
  'occupation-milking-hand': {
    title: '擠奶工',
    text: '收成的田地階段，擁有至少 1／3／5 隻牛可獲得 1／2／3 食物，且不需交出牛。遊戲結束時，每 2 隻牛得 1 分。',
  },
  'occupation-sheep-farmer': {
    title: '養羊農夫',
    text: '每當你派家庭成員取得綿羊時，從供應區額外獲得 1 綿羊。任何時候（繁殖階段除外）都可以用 3 綿羊換 1 牛和 1 野豬。',
  },
  'occupation-master-baker': {
    title: '烘焙大師',
    text: '每當其他玩家烤麵包時，若你有帶麵包符號的進步卡也可以烤麵包。若你自己進行烤麵包行動（未用此卡），額外獲得 1 食物。',
  },
  'occupation-stablehand': {
    title: '馬廄小工',
    text: '每當你建造至少 1 段柵欄時，也獲得 1 座必須立即建造的馬廄（可建在圍起區域內或外），不需支付木材。',
  },

  // ---- Occupations, batch 4: the remainder. ----
  'occupation-veterinarian': {
    title: '獸醫',
    text: '打出此卡時，將 4 綿羊、3 野豬、2 牛放入容器。每回合開始時抽出兩隻動物，若種類相同則留下一隻，其餘放回容器。',
  },
  'occupation-tanner': {
    title: '製革匠',
    text: '將野豬或牛轉換成食物時，可選擇放在此卡上。遊戲結束時，已屠宰的野豬 2／4／6 隻與牛 2／3／4 隻各得 1／2／3 分。',
  },
  'occupation-fencer': {
    title: '築籬工',
    text: '每當其他玩家建造 1 至 4 段柵欄時，你從供應區獲得 1 木材；建造 5 段以上時獲得 2 木材。（你自己建造則沒有好處。）',
  },
  'occupation-village-beauty': {
    title: '村花',
    text: '任何時候都可以支付 3 食物進行一次「家庭成長」，不需放置家庭成員，但必須有空房間。新生兒從下一回合起可以行動。',
  },
  'occupation-fisherman': {
    title: '漁夫',
    text: '每當你使用「釣魚」行動格時，可選擇取走格上食物的兩倍。若這麼做，必須各給釣竿、木筏、獨木舟、魚簍和撈網 1 食物。',
  },
  'occupation-pieceworker': {
    title: '計件工',
    text: '每當你從行動格取得木材、黏土、蘆葦、石頭或穀物時，可用 1 食物再買 1 個同種物品；取得蔬菜時則需 2 食物。',
  },
  'occupation-traveling-salesman': {
    title: '旅行推銷員',
    text: '每當你選擇「小進步」行動時，可改為打出主要進步卡；若選擇「小／主要進步」行動，則可打出 2 張小進步卡。',
  },
  'occupation-animal-dealer': {
    title: '動物販子',
    text: '每當你使用「綿羊」、「野豬」或「牛」行動格時，可支付 1 食物額外取得 1 隻該種動物。（這些行動格分別在第 1、3、4 階段加入。）',
  },
  'occupation-manservant': {
    title: '男僕',
    text: '當你建造石屋時，在剩餘的回合格上各放 3 食物。這些回合開始時，你獲得該食物。（若打出此卡時已有石屋，立即放置。）',
  },
  'occupation-clay-digger': {
    title: '挖泥工',
    text: '加入 3 人遊戲的「1 黏土」行動卡作為額外黏土坑。立即在卡上放 3 黏土，每回合開始時再加 1 黏土。使用此行動的玩家必須付你 3 食物。',
  },
  'occupation-acrobat': {
    title: '雜技演員',
    text: '每當你使用「流浪藝人」行動格時，在所有其他玩家結束回合後，你可將該家庭成員移到空的「開墾」或「取得 1 穀物」行動格並執行該行動。',
  },
  'occupation-adoptive-parents': {
    title: '養父母',
    text: '進行「家庭成長」時，你可以支付 1 食物立即把新生兒安置到房屋中，使其本回合就能行動，且不算作「新生兒」。',
  },
  'occupation-church-warden': {
    title: '教堂執事',
    text: '若尚有 1／3／6／9 回合可玩，立即獲得 1／2／3／4 木材。遊戲結束時，第 14 回合以至少 5 位家庭成員行動的玩家各得 3 分。（客人也計入。）',
  },
  'occupation-taxidermist': {
    title: '標本師',
    text: '將動物轉換成食物時，可將其中一些放在此卡上而非退回供應區。此卡最多容納 1 綿羊、1 野豬和 1 牛，這些動物仍計入分數。',
  },
  'occupation-countryman': {
    title: '鄉下人',
    text: '所有玩家放置完家庭成員後，你可以把位於「取得 1 穀物」或「取得 1 蔬菜」格上、已取得物資的家庭成員移到空的「播種」行動格。',
  },
  'occupation-basin-maker': {
    title: '製盆匠',
    text: '每將 1 隻野豬轉換成食物，你可以從個人供應區放最多 2 木材在此卡上。遊戲結束時，卡上除第 1、4、7、10 個以外的每個木材各得 1 分。',
  },
  'occupation-stockman': {
    title: '牲畜管理員',
    text: '建造第 2 座馬廄時獲得 1 牛，第 3 座獲得 1 野豬，第 4 座獲得 1 綿羊。（一次建造多座馬廄時，可同時取得多隻動物。）',
  },
  'occupation-maid': {
    title: '女僕',
    text: '當你建好黏土屋後，在剩餘的回合格上各放 1 食物。這些回合開始時，你獲得該食物。（若打出此卡時已有黏土屋或石屋，立即放置。）',
  },
  'occupation-storehouse-clerk': {
    title: '倉庫文員',
    text: '回合開始時，若你有至少 5 石頭則獲得 1 石頭；至少 6 蘆葦獲得 1 蘆葦；至少 7 黏土獲得 1 黏土；至少 8 木材獲得 1 木材。',
  },
  'occupation-educator': {
    title: '教育家',
    text: '每當其他玩家打出職業卡時，你可以支付 3 食物也打出一張；從你的第 4 張職業卡起只需 2 食物。（你自己打出職業卡時不能用此卡再打一張。）',
  },
  'occupation-midwife': {
    title: '助產士',
    text: '每當其他玩家生育後家庭人數多於你，你獲得 1 食物；若對方比你多至少 2 人，則獲得 2 食物。（食物來自供應區，不是該玩家。）',
  },
  'occupation-fence-builder': {
    title: '柵欄建造者',
    text: '打出此卡時，將你的一段柵欄放在任一行動格上。當你使用該行動格時，可額外進行建造柵欄的行動。（此後你只剩 14 段柵欄可用。）',
  },
  'occupation-social-climber': {
    title: '攀附者',
    text: '若你是第一位翻修成黏土屋或石屋的玩家，獲得 3 石頭；第二位獲得 2 石頭；第三位獲得 1 石頭。（打出此卡前完成的翻修不計。）',
  },
  'occupation-slaughterman': {
    title: '屠宰工',
    text: '每當其他玩家將動物轉換成食物時，你從供應區獲得 1 食物。餵食階段你最後餵食，以便從他人的屠宰中獲益。（你自己屠宰則沒有額外食物。）',
  },
  "occupation-chief-s-daughter": {
    title: '酋長之女',
    text: '若其他玩家打出「酋長」，你可以立即免費打出此卡（也可以照常用行動格打出）。遊戲結束時，石屋得 3 分，黏土屋得 1 分。',
  },
  'occupation-clay-hut-builder': {
    title: '黏土屋建造者',
    text: '當你住進黏土屋後，在接下來 5 個回合格上各放 2 黏土。這些回合開始時，你獲得該黏土。（若打出此卡時已住黏土屋或石屋，立即放置。）',
  },
  'occupation-gentleman': {
    title: '紳士',
    text: '每當你是該回合最後一位放置家庭成員的玩家，完成該行動後獲得 1 食物。若你用本回合最後一位家庭成員打出此卡，則獲得 2 食物。',
  },
  'occupation-chamberlain': {
    title: '內務總管',
    text: '第 11 回合開始時（若在其後打出則立即），翻開剩餘所有回合卡。只有你可以立即使用這些行動，其他玩家必須等到對應回合。',
  },
  'occupation-fence-deliveryman': {
    title: '柵欄送貨員',
    text: '在目前回合數加 6 和加 10 的回合格上各放 4 段你的柵欄。這些回合開始時，可支付 2 食物立即建造全部 4 段（也可少建），不需支付木材。',
  },
  'occupation-taster': {
    title: '試味員',
    text: '每當其他玩家是起始玩家時，你可以在回合開始時付他 2 食物，搶先放置第一位家庭成員，之後再由起始玩家照常開始。',
  },
  'occupation-ratcatcher': {
    title: '捕鼠人',
    text: '第 10 和 12 回合，其他玩家各有 1 位後代（第 3、4、5 位家庭成員）不能放置，你自己則不受限。此卡最晚須在第 9 回合結束前打出。',
  },
  'occupation-juggler': {
    title: '雜耍藝人',
    text: '每當你使用「流浪藝人」行動格時，可選擇取走卡上食物的兩倍。若這麼做，必須各給魔法師、魔術師、街頭樂手、木偶師、雜技演員、舞者、動物訓練師和說書人 1 食物。',
  },
  'occupation-mail-coach-driver': {
    title: '郵車伕',
    text: '此後直到遊戲結束，其他玩家只有在家庭成員返家時才能取得行動格上的物資。（適用於行動格上與從供應區取得的物資，但不包括卡牌給予的物資。）',
  },
  'occupation-farm-steward': {
    title: '農場管事',
    text: '當你住進黏土屋或石屋後，你下一次的「家庭成長」視為「家庭成長（不需空房）」，之後的家庭成長則照常進行。',
  },
  'occupation-stone-buyer': {
    title: '石材買家',
    text: '每回合首次有玩家取得石頭時，你可以付他 1 食物換取其中 1 石頭，該玩家另從供應區獲得 1 食物作為補償（對方不能拒絕）。若你自己是該回合第一位取得石頭的玩家，則沒有好處。',
  },
  'occupation-perpetual-student': {
    title: '萬年學生',
    text: '打出職業卡時，你可以請其他玩家從你手中隨機抽一張代替自選。若這麼做，在支付費用前先獲得 3 食物，但必須打出被抽中的那張；若付不起費用，缺多少食物就抽多少乞討卡。',
  },
  'occupation-reed-buyer': {
    title: '蘆葦買家',
    text: '每回合首次有玩家取得蘆葦時，你可以付他 1 食物換取其中 1 蘆葦，該玩家另從供應區獲得 1 食物作為補償（對方不能拒絕）。若你自己是該回合第一位取得蘆葦的玩家，則沒有好處。',
  },
  'occupation-guildmaster': {
    title: '行會長',
    text: '取得木工坊或打出細木工時獲得 4 木材；取得陶器坊或打出陶匠時獲得 4 黏土；取得編籃工坊或打出編籃匠時獲得 3 蘆葦。若打出此卡時已有這些卡，每張各獲得 2 個對應建材。',
  },
}
